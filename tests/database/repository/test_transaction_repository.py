...
class TestTransactionRepository(unittest.TestCase):
    ...
    def test_create_transaction(self):
        ...
        # Act
        result = self.repo.create_transaction(transaction_data)

        # Assert
        self.mock_db.add.assert_called_once()
        self.mock_db.commit.assert_called_once()
        self.mock_db.refresh.assert_called_once()
        self.assertEqual(result.vendor, transaction_data["vendor"])
        self.assertEqual(result.amount, transaction_data["amount"])
        self.assertEqual(result.date, transaction_data["date"])
        self.assertEqual(result.description, transaction_data["description"])
        self.assertEqual(result.source, transaction_data["source"])
